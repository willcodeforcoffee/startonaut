...
export default class extends Controller {
  ...
  addTag(tagName) {
    ...
    if (
      this.selectedTags.some(
        (tag) => tag.toLowerCase() === normalizedName.toLowerCase(),
      )
    ) {
      return;
    }
  ...
  updateHighlight() {
    const dropdownItems =
      this.dropdownTarget.querySelectorAll(".dropdown-item");
