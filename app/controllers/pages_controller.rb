class PagesController < ApplicationController
  ...
  def create
    @page = Page.build(user: Current.user)
  ...
  private
    ...
    def set_page
      @page = Current.user.pages.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def page_params
      params.expect(page: [ :user_id, :title, :description ])
    end
end
